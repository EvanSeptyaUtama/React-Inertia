...
//import layout
import Layout from '../../Layouts/Dafault';
          ...
          <div className="card border-0 rounded shadow-sm border-top-success">
            ...
            <div className="card-body">
              <form onSubmit={storePost}>
                ...
                <div className="mb-3">
                  <label className="form-label fw-bold">Isi Content</label>
                  <textarea type="" className="form-control" value={content} onChange={(e) => setContent(e.target.value)} placeholder="Masukkan Judul Content" rows={4}></textarea>
                </div>
                {errors.content && (
                  <div className="alert alert-danger">
                    {errors.content}
